...
var graphModule = (function () {
    ...
    const top_level = { 'name': 'Federal Budget' },
        cashFormat = d3.format(",.2f"),
    ...
    */
    ...
    var drawGraphPie = function (data, taxes_paid = 10489) {
    ...
    */
    var drawTable = function (budget, taxes_paid = 10489) {
    ...
    var tableData = function (budget, tax) {
    ...
    var clearTaxes = function () {
        document.getElementById('tax_graph').innerHTML = "";
        document.getElementById('tax_table').innerHTML = "";

    }
    var clearTooltip = function () {
        let tts = document.querySelectorAll('div.tooltip');
    ...
    return {
        drawGraphPie: drawGraphPie,
        drawTable: drawTable,
        assignGraph: assignGraph
    }
})()
